...
class BaseGraphStorage(StorageNameSpace):
    ...
    async def store_gnn_embeddings(self, embeddings: dict[str, np.ndarray]):
        """Store GNN-generated embeddings."""
        raise NotImplementedError

    async def generate_gnn_embeddings(self, algorithm: str, params: dict) -> dict[str, np.ndarray]:
        """Generate GNN embeddings for nodes or edges."""
        raise NotImplementedError
